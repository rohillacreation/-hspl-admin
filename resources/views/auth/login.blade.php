...
<body class="hold-transition login-page" style="<?php if(env('APP_ENV') == 'local') { ?>background-image: url('{{ asset('images/backgroundimage/abc.jpg') }}')<?php } else { ?> background-image: url('{{ asset('public/images/backgroundimage/abc.jpg') }}') <?php } ?>;
  ...
  <!-- <body class="hold-transition login-page" style="background-image: url('{{ asset('public/images/backgroundimage/abc.jpg') }}; background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: cover;
...
<div class="login-box">
  <div class="login-logo">
    <a href="#">
     ...
     <img src="{{ asset('images/backgroundimage/cname.png') }}" style="width: auto;height: 35px;"></a>
    
    @else
    
     <img src="{{ asset('public/images/backgroundimage/cname.png') }}" style="width: auto;height: 35px;"></a> 
  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group has-feedback">
        <input id="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email">
          ...
          <div class="modal-content" >
            <div class="modal-header">
              ...
              <div class="box-body" id="resetpassword" style="min-height: 100px">
                 <!-- <form role="form" method="POST" action="{{ url('/new_password') }}">
                    @csrf -->
...
<script>
  ...
  function forget() 
   ...
   function send_otp()
   {  
      var appBaseUrl = {!! json_encode(url('/')) !!}; 
   ...
   {  
      ...
      var confirmpassword = $('#confirmpassword').val();
       $.ajax({
           ...
           type:'POST',
           data:{password : password,confirmpassword: confirmpassword,  _token: '{{csrf_token()}}' }, 
           success: function(result)
           {
              if(result == '200')
              {
