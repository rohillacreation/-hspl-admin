	        ...
	        <div class="col-xs-12">
	          	<div class="box">
		            <div class="box-header">
		            	...
		            	@endif
		              	<div class="col-xs-12">
 	       					<a class="btn btn-success" href="{{ url('/division-master/create') }}">Add Division Master</a>
        				</div>
		            </div>
		            <div class="box-body" >
			                  ...
			                  @foreach($data as $key)
			                    <tr>
			                        ...
			                        <td style="float: left;padding: 0;">
			                         <a href="{{ url('/division-master') }}/{{$key->DevisionId}}/edit"><i class="fa fa-pencil btn btn-info"></i></a>
			                         <form method="Post" action="{{url('division-master')}}/{{$key->DevisionId}}">
