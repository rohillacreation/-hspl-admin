	        ...
	        <div class="col-xs-12">
	          	<div class="box">
		            <div class="box-header">
		            	...
		            	<?php endif; ?>
		              	<div class="col-xs-12">
 	       					<a class="btn btn-success" href="<?php echo e(url('/division-master/create')); ?>">Add Division Master</a>
        				</div>
		            </div>
		            <div class="box-body" >
			                ...
			                <tbody>
			                  ...
			                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                    <tr>
			                        ...
			                        <td><?php echo e($key->GST); ?></td>
			                        
			                        <td style="float: left;padding: 0;">
			                         <a href="<?php echo e(url('/division-master')); ?>/<?php echo e($key->DevisionId); ?>/edit"><i class="fa fa-pencil btn btn-info"></i></a>
			                         <form method="Post" action="<?php echo e(url('division-master')); ?>/<?php echo e($key->DevisionId); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel\hspl\resources\views/divisionmaster/index.blade.php ENDPATH**/ ?>