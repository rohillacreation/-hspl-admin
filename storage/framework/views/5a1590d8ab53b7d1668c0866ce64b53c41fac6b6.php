...
<?php endif; ?>
<form role="form" method="post" action="<?php echo e(url('/service-master/addperformance')); ?>" id="analysis">
   <?php echo csrf_field(); ?>
   <h3>Key Competencies</h3>
   
   <input type="hidden" name="ServiceId" id="ServiceId" value="<?php echo e($service); ?>">
   <input type="hidden" name="EngineerId" id="EngineerId" value="<?php echo e($engineer); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel\hspl\resources\views/servicemaster/performance_point.blade.php ENDPATH**/ ?>