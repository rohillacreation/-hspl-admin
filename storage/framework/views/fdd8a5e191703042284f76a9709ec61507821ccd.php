	        ...
	        <div class="col-xs-12">
	          	<div class="box">
		            <div class="box-header">
		            	...
		            	<?php endif; ?>
		              	<div class="col-xs-12">
 	       					<a class="btn btn-success" href="<?php echo e(url('/companydetails/create')); ?>">Add Company</a>
        				</div>
		            </div>
		            <div class="box-body" >
			                ...
			                <tbody>
			                  ...
			                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                    <tr>
			                        ...
			                        <td><?php echo e($key->CompanyCode); ?></td>
			                        <td><?php echo e($key->CompanyNumber); ?></td>
			                        <td><?php echo e($key->CompanyAddress); ?></td>
			                        <td><?php echo e($key->GSTNumber); ?></td>
			                        <!-- <td><?php echo e($key->nickname); ?></td> -->
			                        
			                        <td style="float: left;padding: 0;">
			                         <a href="<?php echo e(url('/companydetails')); ?>/<?php echo e($key->CompanyId); ?>/edit"><i class="fa fa-pencil btn btn-info"></i></a>
			                         <form method="Post" action="<?php echo e(url('companydetails')); ?>/<?php echo e($key->CompanyId); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel\hspl\resources\views/companymaster/index.blade.php ENDPATH**/ ?>