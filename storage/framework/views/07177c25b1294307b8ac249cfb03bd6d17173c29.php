      ...
      <div class="row">
         <div class="col-md-12">
            <div class="box box-primary">
               ...
               <form role="form" method="post" action="<?php echo e(url('/machine-master')); ?>/<?php echo e($key->MachineId); ?>">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="OrganisationId" name="OrganisationId" onchange="showrailwayorprivate(this);">
                        ...
                        <option value="<?php echo e($OrganisationData->OrganisationId); ?>" <?php echo e(($OrganisationData->OrganisationId == $key->OrganisationId) ? 'selected' : ''); ?>><?php echo e($OrganisationData->OrganisationName); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="CompanyName" name="CompanyName" value="<?php echo e($key->Company); ?>">
...
unset($__errorArgs, $__bag); ?>" id="CompanyLocation" name="CompanyLocation" value="<?php echo e($key->CompanyLocation); ?>">
...
unset($__errorArgs, $__bag); ?>" id=  "RailwaysId" name="RailwaysId" onchange="GetDivision(this)">
                           ...
                           <option value="<?php echo e($Railway->RailwaysId); ?>" <?php echo e(($Railway->RailwaysId == $key->RailwaysId) ? 'selected' : ''); ?>><?php echo e($Railway->RailwaysZone); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </select>
...
unset($__errorArgs, $__bag); ?>" id="MachineType" name="MachineType">
                         ...
                         <option value="<?php echo e($machine->MachineCategoryId); ?>" <?php echo e(($machine->MachineCategoryId == $key->MachineCategoryId) ? 'selected' : ''); ?>> <?php echo e($machine->MachineCategoryName); ?> </option>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </select>
...
unset($__errorArgs, $__bag); ?>" id="ClientName" name="ClientName" value="<?php echo e($key->ClientName); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineName" name="MachineName" value="<?php echo e($key->MachineName); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineSerialNumber" name="MachineSerialNumber" value="<?php echo e($key->MachineSerialNumber); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineOrderNo" name="MachineOrderNo" value="<?php echo e($key->MachineOrderNo); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineWarranty" name="MachineWarranty" onchange="ShowHideDiv(this)" >
                              ...
                              <option value="W"  <?php echo e(($key->MachineWarranty == 'W') ? 'selected' : ''); ?>>Yes</option>
                              <option value="NW"  <?php echo e(($key->MachineWarranty == 'NW') ? 'selected' : ''); ?>>No</option>
                           </select>
                           <?php $__errorArgs = ['MachineCategoryId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="MachineWarrantyFrom" name="MachineWarrantyFrom" value="<?php echo e($key->MachineWarrantyFrom); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineWarrantyTo" name="MachineWarrantyTo" value="<?php echo e($key->MachineWarrantyTo); ?>">
...
unset($__errorArgs, $__bag); ?>" id="MachineAllotmentDate" name="MachineAllotmentDate" value="<?php echo e($key->MachineAllotmentDate); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\laravel\hspl\resources\views/machinemaster/edit_machine_master.blade.php ENDPATH**/ ?>